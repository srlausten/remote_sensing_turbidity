...
There was no conclusive evidence that light sensors can be a source of truth for measuring turbidity. We rejected both hypotheses: light sensors could be used for measuring turbidity and that sensors after the mine site would show higher levels of turbidity (lower light levels). 
